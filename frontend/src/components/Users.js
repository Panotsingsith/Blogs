...
export default class Users extends Component {
    ...
    submit(event, id) {
        ...
        if (id === 0) {
            axios.post(`http://localhost:8000/api/products/`, { name: this.state.name, price: this.state.price, stock: this.state.stock, description: this.state.description })
                .then(() => {
                    this.componentDidMount();
                })

        } else {
            axios.put(`http://localhost:8000/api/products/${id}`, { name: this.state.name, price: this.state.price, stock: this.state.stock, description: this.state.description })
                .then(() => {
                    this.componentDidMount();
                })
        }
